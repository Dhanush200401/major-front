...
//     this.socket = io("https://major-back.onrender.com", {
...
//     try {
//       const response = await fetch(`${API}/api/rooms/join`, {
//         method: "POST",
  ...
  handleCreateRoom = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (this.socket && this.state.socketConnected) {
          this.socket.emit("join", { roomId: createRoomId });
        }
